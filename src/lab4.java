...
public class lab4{
    ...
    public void main(String[] args) throws Exception {
        ...
        int M = Integer.getInteger(args[2]);    //Machine size in words
        int P = Integer.getInteger(args[3]);    //Page size in words
        int S = Integer.getInteger(args[4]);    //Size of each process
        int J = Integer.getInteger(args[5]);    //Job mix, determines A,B,C
        int N = Integer.getInteger(args[6]);    //Number of references for each process
        String R = args[7];                     //Replacement algorithm, LIFO, RANDOM, or LRU
